$(document).ready(function() {
	...
	addItemBtn.addEventListener("click", () => {
		...
		qtyHelp.setAttribute("id", "qtyHelp");
		...
		conditionHelp.setAttribute("id", "conditionHelp");
		...
		upgradesModsLbl.setAttribute("for", "upgradesMods");
		...
		upgradesModsInput.setAttribute("id", "upgradesMods");
		...
		upgradesModsHelp.setAttribute("id", "upgradesModsHelp");
		...
		accessoriesLbl.setAttribute("for", "accessories");
		...
		accessoriesInput.setAttribute("id", "accessories");
		...
		accessoriesHelp.setAttribute("id", "accessoriesHelp");
		...
		picturesInput.setAttribute("id", "pictures");
		...
		picturesHelp.setAttribute("id", "picturesHelp");
		...
		videoHelp.setAttribute("id", "videoHelp");
